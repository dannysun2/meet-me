	    ...
	    _createClass(App, [{
	        ...
	        value: function _handleClick() {
	            ...
	            _axios2.default.get(url).then(function (response) {
	                ...
	                console.log(_this2.state.places);
	            }).catch(function (err) {
	                console.log(err);
	            });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'text', onChange: this._handleInput1.bind(this) }),
	                _react2.default.createElement('input', { type: 'text', onChange: this._handleInput2.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = function Button(props) {
	    ...
	    return _react2.default.createElement("input", { type: "button", value: "Find Food", onClick: _handleBtn });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SimpleMap(props) {
	  return _react2.default.createElement(
	    "div",
	    { className: "map-frame" },
	    _react2.default.createElement("iframe", { width: "100%", height: "100%", frameBorder: "0", scrolling: "no", marginHeight: "0", marginWidth: "0", src: "http://maps.google.com/maps?hl=en&ie=UTF8&ll=37.0625,-95.677068&spn=56.506174,79.013672&t=m&z=4&output=embed" })
	  );
	}
